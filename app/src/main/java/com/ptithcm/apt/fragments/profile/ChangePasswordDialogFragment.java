...
public class ChangePasswordDialogFragment extends DialogFragment {
    ...
    private void setupListeners() {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            profileViewModel.validateAndChangePassword(oldPass, newPass, confirmPass);
        });
    }
