...
public interface ResidentApiService {
    ...
    @POST("api/v1/admin/residents/apartments/{roomNumber}/members")
    ...
    @GET("api/v1/admin/residents/apartments/{apartmentId}")
